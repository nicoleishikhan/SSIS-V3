                ...
                try:
                    if 'student_photo' in request.files:
                        ...
                        if uploaded_file and allowed_file(uploaded_file.filename):
                            ...
                            cloudinary_response = cloudinary.uploader.upload(uploaded_file, folder=current_app.config['CLOUDY_FOLDER'])
            ...
            if not Student.is_student_unique(student_id, first_name, last_name, gender, year, course_id, current_student_id=id):
                ...
                try:
                    ...
                    if uploaded_file and uploaded_file.filename != '':
                        ...
                        # Use original photo URL if no new photo uploaded
